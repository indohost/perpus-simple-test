    ...
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Rak</h6>
            </div>
            <div class="card-body">
                <div class="col-lg-12">
                    @foreach ($rack as $d)
                        <form role="form" action="/admin/rack/update/{{ $d->id }}" method="post">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label>Kode</label>
                                <input type="text" id="" disabled name="r_kode" value="{{ $d->r_kode }}" required="required"
                            ...
                            <div class="form-group">
                                <label>Lokasi</label>
                                <input type="text" id="" name="r_location" value="{{ $d->r_location }}" required="required"
